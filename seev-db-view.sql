...
WHERE POI.ORDER_NUMBER = '8bc0a72e08dd413f923996783ed8854d'
--AND PS.SITE_NAME = ''
--AND PBI.PARENT_ID IS NULL
--AND PBI.PARENT_ID IS NOT NULL
--AND PBI.ITEMCODE = ''
--AND PBI.BASKET_ITEM_ID = '6c75b0ac5e6143ecb6434699975a0c24'
AND (PBI.BASKET_ITEM_ID = '628ce91d40ca4ad39094ccf6f11d824f' OR PBI.PARENT_ID = '628ce91d40ca4ad39094ccf6f11d824f')
--AND PIL.LEAF_NAME = ''
